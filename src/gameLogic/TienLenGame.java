...
public abstract class TienLenGame {
	...
	protected Deck motherPack;
	protected int numOfPlayer;
	protected int numOfAIPlayer;
	protected Deck lastPlay;
	protected Deck selectionCard;
	protected int round;
	protected int nowPlayer;
	protected Card minCard = new Card();// đã thêm-là lá bài bé nhất, 4 players -> là 3 bích
	protected int key;// đã thêm-biến key thể hiện được ván bài đầu tiên, điều này giúp cho logic của
	...
	public TienLenGame(int numOfPlayer, int numOfAIPlayer) {
...
//			motherPack.printDeck();
	...
	public abstract PlayType checkTypePlay(Deck deck);

	// Check xem có là sảnh
	public abstract PlayType checkSanh(Deck deck);

	public boolean isTheEnd() {
		return rank.size() == numOfPlayer;
	}
